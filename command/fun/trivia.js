...
let h = new (require('html-entities').AllHtmlEntities);
const fetch = require('node-superfetch');

module.exports = {
    run: async (client, msg) => {
        fetch.get("https://opentdb.com/api.php?amount=50&type=boolean").end(async (err, response) => {
